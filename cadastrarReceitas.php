<?php
  ...
  if ($_POST) {
      ...
      $sql = "INSERT INTO movimentos (DescMovimento, DtMovimento, Valor, CatReceitas_CodReceita)
      VALUES ('$DescMovimento', '$DtMovimento', $Valor, $CatReceitas_CodReceita)";
...
<html lang="pt-br">
  <head>
    ...
    <title>Finances - Cadastro Receita</title>
...
<div class="container">
        <div style="border-radius: 5px; padding: 10px" class="row bg-light">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                <a class="nav-link active" href="cadastrarReceitas.php">Cadastrar Receitas</a>
                </li>
                <li class="nav-item">
        ...
        <div class="col">
          <form method="POST">
            ...
            <div class="form-group">
              ...
              <select class="form-select" name="CatReceitas_CodReceita">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    echo "<option>Sem receitas cadastradas</option>";
                }
